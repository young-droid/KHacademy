...
public class MainService {
			...
			try {
				...
				if (loginMember == null) { // 로그인이 되어있지 않은 경우
					...
					case 0:
						...
						break;
					case 1:
						loginService.startGame(loginMember);
						break;
					case 2:
						loginService.selectMyInfo(loginMember);
						break;
					case 3:
						loginService.selectAllMember(members);
						break;
					case 4:
						loginService.updatePassword(loginMember);
						break;
	...
	public void signUp() {
		...
		for(Member mem : members) {
			if(memberId.equals(mem.getMemberName())) {
