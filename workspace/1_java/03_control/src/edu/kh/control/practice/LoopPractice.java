...
public class LoopPractice {
	...
	public void practice4() {
		...
		/*
		 * if(input1 <= 0 || input2 <= 0) { System.out.println("1 이상의 숫자를 입력해주세요."); }
		 * else if (input1 > input2) { for( ; input2 <= input1 ; input2++) {
		 * System.out.print(input2 + " "); } } else { for( ; input1 <= input2 ;
		 * input1++) { System.out.print(input1 + " "); } }
		 */
	}
