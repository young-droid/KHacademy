...
public class ConditionExample { // 예제 작성용
	...
	public void ex1() {
		...
		/*
		 * if 문 - 조건식이 true 일때만 내부 코드 수행
		 * 
		 * [작성법] if(조건식){ 조건식이 true 일 때 수행할 코드; }
		 */
	...
	public void ex2() {
		...
		/*
		 * if - else 문 - 조건식 결과가 true면 if 문, false면 else 구문이 수행됨
		 * 
	...
	public void ex5() {
		...
		/*
		 * if(age >= 0 && age <= 13){ result = "어린이"; } else if (age <= 19) { result =
		 * "청소년"; } else if (age <= 100){ result = "성인"; } else { result =
		 * "잘못 입력하셨습니다."; }
		 */
