<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <pre>
        Servlet/JSP 에는 4종류 범위를 나타내는 내장 객체가 존재한다@
        -> 각 종류마다 영향을 끼치는 범위가 달라짐

        <h4>1. page (pageContext) : 현재 페이지 (페이지 스코프)</h4>
        -> 현재 JSP에서만 사용 가능한 객체 (Servlet ㅌ)

        <h4>2. request (요청)</h4>
        -> 요청 받은 페이지(Servlet / JSP)와
           위임 받은 페이지(JSP / Servlet)에서 유지되는 객체
        ...
        <% // 스크립틀릿 : JSP에서 Java 코드를 작성하는 영역
           // String pageMessage = "page scope 입니다." -> 이렇게 작성하면 안됨
