    ...
    <main>
        ...
        <section class="signUp-content">
            ...
            <form action="signUp" method="post" name="signUp-form">
                ...
                <span class="signUp-message">메일을 받을 수 이메일을 입력해주세요</span>
                ...
                <div class="signUp-input-area">
                    <input type="text" id="emailCheck" placeholder="인증번호 입력" maxlength="6" autocomplete="off" required>
                ...
                <div class="signUp-input-area">
                    <input type="text" id="memberNickname" name="memberNickname" placeholder="닉네임 입력" maxlength="10"
                        autocomplete="off" required>
