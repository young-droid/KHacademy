...
-- 게시글 샘플 데이터
INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 게시글 1', 'SAMPLE1 내용입니다.', DEFAULT, DEFAULT,101);

INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 게시글 2', 'SAMPLE2 내용입니다.', DEFAULT, DEFAULT,101);

INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 게시글 3', 'SAMPLE3 내용입니다.', DEFAULT, DEFAULT,101);
...
-- 댓글 샘플 데이터 삽입
INSERT INTO REPLY
VALUES(SEQ_REPLY_NO.NEXTVAL, '샘플1의 댓글1', DEFAULT, 555, 2);

INSERT INTO REPLY
VALUES(SEQ_REPLY_NO.NEXTVAL, '샘플1의 댓글2', DEFAULT, 101, 1);

INSERT INTO REPLY
VALUES(SEQ_REPLY_NO.NEXTVAL, '샘플1의 댓글3', DEFAULT, 101, 1);
...
-- 특정 게시글의 댓글 목록 조회
SELECT R.*, M.MEMBER_NM FROM REPLY R 
...
DELETE FROM BOARD 
WHERE BOARD_NO = 1; 
-- ORA-02292: 무결성 제약조건(MEMBER_CYJ.SYS_C007536)이 위배되었습니다- 자식 레코드가 발견되었습니다

SELECT * FROM BOARD WHERE BOARD_NO = 1;
SELECT * FROM REPLY WHERE BOARD_NO = 1; -- REPLY 테이블에서 BOARD 테이블 1번 게시글을 참조하는 댓글
	--> 기본적으로 삭제 불가 
	--> 삭제 옵션을 추가하면 가능
-- ON DELETE SET NULL(자식 컬럼을 NULL로 변경)
-- ON DELETE CASCADE(참조하던 자식 행도 삭제)

-- 제약조건은 ALTER(변경) 없음 -> 추가 삭제만 가능
	--> 삭제 후 다시 추가 

-- 기존 REPLY 테이블 FK 제약조건 삭제
ALTER TABLE REPLY DROP CONSTRAINT SYS_C007536;

-- 삭제 옵션이 추가된 FK를 다시 추가
ALTER TABLE REPLY ADD FOREIGN KEY (BOARD_NO) REFERENCES BOARD (BOARD_NO) ON DELETE CASCADE;
...
SELECT * FROM MEMBER ;
SELECT * FROM BOARD ; 
INSERT INTO REPLY VALUES (SEQ_REPLY_NO.NEXTVAL, '내용1', DEFAULT, 101, 2);


-- 게시글 작성
INSERT INTO BOARD VALUES (SEQ_BOARD_NO.NEXTVAL, '안녕하세요, 오독서입니다...', '지각 죄송합니다...', DEFAULT, DEFAULT, 101);
...
SELECT * FROM BOARD;
SELECT UNIQUE(MEMBER_NO)  FROM BOARD;
