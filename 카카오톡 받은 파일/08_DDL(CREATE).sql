...
CREATE TABLE MEMBER(
	...
	MEMBER_SSN CHAR(14), -- 891212-1234567
...
SELECT *
FROM USER_TABLES; -- 딕셔너리 뷰(데이터 딕셔너리에서 일부분만 뽑아서 만든 가상 테이블)
...
--> 가입일 DEFAULT 활용
INSERT INTO MEMBER
VALUES ('MEM01', 'PASS01', '멤버일', '001126-1234567', DEFAULT);

-- 추가 샘플 데이터 삽입
--> 가입일 SYSDATE 활용
INSERT INTO MEMBER
VALUES ('MEM02', 'PASS02', '멤버이', '951126-2234567', SYSDATE);

--> 가입일 미작정 시 -> DEFAULT 값이 반영됨
INSERT INTO MEMBER(MEMBER_ID, MEMBER_PWD, MEMBER_NAME, MEMBER_SSN)
VALUES ('MEM03', 'PASS03', '멤버삼', '331126-3234567');
...
INSERT INTO MEMBER2
VALUES('홍길동', 991126-1234567);
INSERT INTO MEMBER2
VALUES('김철수', 001126-1234567);
INSERT INTO MEMBER2
VALUES('이영희', 0011261234567);
INSERT INTO MEMBER2
VALUES('이나라', 9011261234567);
...
-- 삽입/수장 시 NULL값을 허용되지 않게 컬럼레벨에서 제한

CREATE TABLE USER_USED_NN(
	USER_NO NUMBER NOT NULL, -- 사용자 번호 (무조건 존재해야함 == NULL X!)
				--> 컬럼레벨 제약조건 설정
	USER_ID VARCHAR2(20),
...
-- ORA-01400: NULL을 ("KH_KCY"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_KCY.USER_ID_U)에 위배됩니다
...
-- ORA-00001: 무결성 제약 조건(KH_KCY.USER_ID_NAME_U)에 위배됩니다
...
-- ORA-00001: 무결성 제약 조건(KH_KCY.USER_NO_PK)에 위배됩니다 == UNIQUE 오류와 같음
--> 기본키 중복으로 오류

INSERT INTO USER_USED_PK
VALUES(NULL, 'USER01', 'PASS01', '유저일', 'M', '010-1234-5678', 'USER01@KH.OR.KR');
-- ORA-01400: NULL을 ("KH_KCY"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다 == NOT NULL 오류와 같음
--> 기본키가 NULL 이므로 오류
...
-- ORA-00001: 무결성 제약 조건(KH_KCY.USERNO_USERID_PK)에 위배됩니다
...
INSERT INTO USER_USED_FK
VALUES(2, 'USER02', 'PASS02', '유저이', 'M', '010-1234-5678', 'USER01@KH.OR.KR', 20);

INSERT INTO USER_USED_FK
VALUES(3, 'USER03', 'PASS03', '유저삼', 'M', '010-1234-5678', 'USER01@KH.OR.KR', NULL);
--> NULL 사용 가능
...
INSERT INTO USER_USED_FK
VALUES(4, 'USER04', 'PASS04', '유저사', 'M', '010-1234-5678', 'USER01@KH.OR.KR', 40);
-- ORA-02291: 무결성 제약조건(KH_KCY.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
--> 참조 무결성 위배
...
SELECT *
FROM USER_GRADE; -- 참조를 당하는 테이블 == 부모 테이블

SELECT *
FROM USER_USED_FK; -- 참조를 하는 테이블 == 자식 테이블

DELETE FROM USER_GRADE 
WHERE GRADE_CODE = 30;
-- ORA-02292: 무결성 제약조건(KH_KCY.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
SELECT *
FROM USER_GRADE2; -- 부모 테이블 삭제 확인(10 없음)

SELECT *
FROM USER_USED_FK2; -- 자식 테이블 NULL 변환 확인
...
SELECT *
FROM USER_GRADE3; -- 부모 테이블 삭제 확인(30 없음)

SELECT *
FROM USER_USED_FK3; -- 30을 참조하던 자식 행 삭제 확인(종속 관계의 행이 모두 삭제됨)
...
-- CHECK(컬럼명 비교연산자 비교값)
-- 주의 : 비교값을 리터럴만 사용 가능, 변하는 값 또는 함수 사용 불가
...
-- ORA-02290: 체크 제약조건(KH_KCY.GENDER_CHECK)이 위배되었습니다

-- GENDER 컬럼에 CHECK 제약조건으로 'F' 또는 'M' 만 기록 가능하게 함
...
VALUES (1, 'USER01', 'PASS01', '111111-1111111', '남', '010-1111-1111', '호주 시드니', 'N', 20);

INSERT INTO USER_TEST
VALUES (2, 'USER02', 'PASS02', '222222-2222222', '여', '010-2222-2222', '한국 경기도', 'N', 22);

INSERT INTO USER_TEST
VALUES (3, 'USER03', 'PASS03', '333333-1333333', '남', '010-3333-3333', '한국 부산', 'N', 33);

INSERT INTO USER_TEST
VALUES (4, 'USER04', 'PASS04', '444444-1444444', '남', '010-4444-4444', '호주 브리즈번', 'Y', 44);

INSERT INTO USER_TEST
VALUES (5, 'USER05', 'PASS05', '555555-2555555', '여', '010-5555-5555', '호주 멜버른', 'N', 55);
...
AS SELECT * FROM EMPLOYEE
   WHERE 1 = 0; -- 일치하는 데이터가 없도록 반드시 FALSE인 내용을 작성
...
-- 수업 때 사용하던 테이블에는 FK 제약조건이 없는 상태이므로 추가
